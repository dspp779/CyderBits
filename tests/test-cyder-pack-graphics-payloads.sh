...
assert_contains "$pack" '"$name" == dxvk' \
  "graphics pack must stamp DXVK as a Wine builtin"
assert_not_contains "$pack" 'dxvk2' \
  "graphics pack must not produce the deferred DXVK 2 payload"
