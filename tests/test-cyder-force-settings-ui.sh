...
assert_contains "$ui" "關閉所有 Wine 程序" "advanced prefs should expose stop-all Wine"
assert_contains "$ui" "打開下載頁面" "missing GPTK install should offer Apple download page"
assert_contains "$ui" 'title: "安裝 GPTK…"' "GPTK install button should use a short label"
