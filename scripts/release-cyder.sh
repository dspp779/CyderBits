...
Options:
  ...
  --version VERSION       CFBundle version (test default: 0.9.0-dev;
                          release default: 0.9.0 or CYDER_APP_VERSION)
...
case "$CHANNEL" in
  test)
    ...
    CYDER_APP_VERSION="${APP_VERSION:-${CYDER_APP_VERSION:-0.9.0-dev}}"
  ...
  release)
    ...
    require_developer_id
    CYDER_APP_VERSION="${APP_VERSION:-${CYDER_APP_VERSION:-0.9.0}}"
    export CYDER_APP_VERSION
