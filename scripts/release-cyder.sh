...
Options:
  ...
  --version VERSION       CFBundle version (test default: 0.9.5-dev;
                          release default: 0.9.5 or CYDER_APP_VERSION)
...
case "$CHANNEL" in
  test)
    ...
    CYDER_APP_VERSION="${APP_VERSION:-${CYDER_APP_VERSION:-0.9.5-dev}}"
  ...
  release)
    ...
    CYDER_APP_VERSION="${APP_VERSION:-${CYDER_APP_VERSION:-0.9.5}}"
    export CYDER_APP_VERSION
