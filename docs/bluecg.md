...
- **視窗縮放黑屏（已由 A6 final 解決）**：Cyder 現行 engine 為 `CX26.3.0-W11-Cyder006`（含 A6 same-view backing sync）；原版／A2／A4 的歷史差異與 fallback 見 [bluecg-winemac-resize-black-screen.md](bluecg-winemac-resize-black-screen.md)。首版 A6 驗收 artifact（`CX26.2.0-W11-Cyder003`）見 [bluecg-winemac-a6-engine.md](bluecg-winemac-a6-engine.md)
...
- [games/bluecg/README.md](games/bluecg/README.md) — 依問題分類的 BlueCG 文件入口
- [bluecg-winemac-a6-engine.md](bluecg-winemac-a6-engine.md) — A6 final engine artifact 與驗收
