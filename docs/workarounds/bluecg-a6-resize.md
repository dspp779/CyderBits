...
正式 engine：`CX26.3.0-W11-Cyder006`（Cyder 現行封裝；含 A6 same-view backing sync）。首版 A6 驗收 artifact `CX26.2.0-W11-Cyder003` 與 SHA-256 見 [A6 engine artifact](../bluecg-winemac-a6-engine.md)。目前已驗收：
