...
| A6 engine artifact | `CX26.2.0-W11-Cyder003`，已完成 BlueCG 驗收 | [artifact 與重現方式](../../bluecg-winemac-a6-engine.md) |
...
- 需要 Retina+DPI 與進入遊戲後 resize、Alt+Enter、最小化／還原時，使用 [A6 final engine](../../bluecg-winemac-a6-engine.md)。
