...
| A6 engine artifact | 現行 Cyder：`CX26.3.0-W11-Cyder007`；首版驗收 artifact 為 `CX26.2.0-W11-Cyder003` | [artifact 與重現方式](../../bluecg-winemac-a6-engine.md) |
...
- 需要 Retina+DPI 與進入遊戲後 resize、Alt+Enter、最小化／還原時，使用 Cyder 現行 engine（`CX26.3.0-W11-Cyder007`）或 [A6 final engine](../../bluecg-winemac-a6-engine.md) artifact 重現流程。
